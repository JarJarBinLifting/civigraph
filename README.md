...
La carte utilise des disques à monogramme pour les personnes et des pictogrammes par type d’entité. La comparaison affiche les portraits sourcés des deux personnes lorsqu’ils sont disponibles, avec les initiales en secours. Ses liens indiquent les périodes de participation ; plusieurs passages restent séparés et les dates absentes sont signalées. Les noms affichés gardent une taille de 12,5 à 14 pixels CSS, sur deux lignes au maximum. Leur placement privilégie le centre, la sélection et le parcours ; masquer une étiquette ne retire jamais un nœud. Ouvrir une fiche conserve le zoom et la zone observée. « Lire les distances » précise la légende ; la taille du centre indique uniquement son rôle dans l’exploration.
